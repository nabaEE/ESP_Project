...
@FindBy(xpath="//div[@id='LegalEntity_Name_UniqueList']/p[2]")
private WebElement searchedLegalEntity;
	


/************Getters Usage*************/
public WebElement getSearchedLegalEntity()
{
	return searchedLegalEntity;
}
